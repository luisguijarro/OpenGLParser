...
namespace fgtk.OpenGL
{
	public static class OpenGL3_0
	{
		...
		{
			i_OpenGL3_0.glBlendFuncSeparate(sfactorRGB, dfactorRGB, sfactorAlpha, dfactorAlpha);
		}
		...
		{
			i_OpenGL3_0.glBlitFramebuffer(srcX0, srcY0, srcX1, srcY1, dstX0, dstY0, dstX1, dstY1, mask, filter);
		}
		public static void glBufferData(BufferTargetARB target, IntPtr size, IntPtr data, BufferUsageARB usage)
		{
			i_OpenGL3_0.glBufferData(target, size, data, usage);
		}
		...
		{
			i_OpenGL3_0.glBufferSubData(target, offset, size, data);
		}
		...
		{
			i_OpenGL3_0.glCompressedTexImage1D(target, level, internalformat, width, border, imageSize, data);
		}
		...
		{
			i_OpenGL3_0.glCompressedTexImage2D(target, level, internalformat, width, height, border, imageSize, data);
		}
		...
		{
			i_OpenGL3_0.glCompressedTexImage3D(target, level, internalformat, width, height, depth, border, imageSize, data);
		}
		...
		{
			i_OpenGL3_0.glCompressedTexSubImage1D(target, level, xoffset, width, format, imageSize, data);
		}
		...
		{
			i_OpenGL3_0.glCompressedTexSubImage2D(target, level, xoffset, yoffset, width, height, format, imageSize, data);
		}
		...
		{
			i_OpenGL3_0.glCompressedTexSubImage3D(target, level, xoffset, yoffset, zoffset, width, height, depth, format, imageSize, data);
		}
		public static void glCopyPixels(Int32 x, Int32 y, Int32 width, Int32 height, PixelCopyType type)
		{
			i_OpenGL3_0.glCopyPixels(x, y, width, height, type);
		}
		...
		{
			i_OpenGL3_0.glCopyTexImage1D(target, level, internalformat, x, y, width, border);
		}
		...
		{
			i_OpenGL3_0.glCopyTexImage2D(target, level, internalformat, x, y, width, height, border);
		}
		public static void glCopyTexSubImage1D(TextureTarget target, Int32 level, Int32 xoffset, Int32 x, Int32 y, Int32 width)
		{
			i_OpenGL3_0.glCopyTexSubImage1D(target, level, xoffset, x, y, width);
		}
		...
		{
			i_OpenGL3_0.glCopyTexSubImage2D(target, level, xoffset, yoffset, x, y, width, height);
		}
		...
		{
			i_OpenGL3_0.glFramebufferRenderbuffer(target, attachment, renderbuffertarget, renderbuffer);
		}
		...
		{
			i_OpenGL3_0.glFramebufferTexture1D(target, attachment, textarget, texture, level);
		}
		...
		{
			i_OpenGL3_0.glFramebufferTexture2D(target, attachment, textarget, texture, level);
		}
		...
		{
			i_OpenGL3_0.glFramebufferTexture3D(target, attachment, textarget, texture, level, zoffset);
		}
		...
		{
			i_OpenGL3_0.glGetActiveAttrib(program, index, bufSize, ref length, ref size, ref type, ref name);
		}
		...
		{
			i_OpenGL3_0.glMap2d(target, u1, u2, ustride, uorder, v1, v2, vstride, vorder, ref points);
		}
		...
		{
			i_OpenGL3_0.glRenderbufferStorage(target, internalformat, width, height);
		}
		...
		{
			i_OpenGL3_0.glTexImage1D(target, level, internalformat, width, border, format, type, pixels);
		}
		...
		{
			i_OpenGL3_0.glTexImage2D(target, level, internalformat, width, height, border, format, type, pixels);
		}
		...
		{
			i_OpenGL3_0.glTexSubImage1D(target, level, xoffset, width, format, type, pixels);
		}
		...
		{
			i_OpenGL3_0.glTexSubImage2D(target, level, xoffset, yoffset, width, height, format, type, pixels);
		}
		...
		{
			i_OpenGL3_0.glVertexAttribIPointer(index, size, type, stride, pointer);
		}
