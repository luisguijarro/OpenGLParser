...
namespace fgtk.OpenGL
{
	public static class OpenGL2_1
	{
		...
		{
			i_OpenGL2_1.glBlendFuncSeparate(sfactorRGB, dfactorRGB, sfactorAlpha, dfactorAlpha);
		}
		public static void glBufferData(BufferTargetARB target, IntPtr size, IntPtr data, BufferUsageARB usage)
		{
			i_OpenGL2_1.glBufferData(target, size, data, usage);
		}
		...
		{
			i_OpenGL2_1.glBufferSubData(target, offset, size, data);
		}
		...
		{
			i_OpenGL2_1.glCompressedTexImage1D(target, level, internalformat, width, border, imageSize, data);
		}
		...
		{
			i_OpenGL2_1.glCompressedTexImage2D(target, level, internalformat, width, height, border, imageSize, data);
		}
		...
		{
			i_OpenGL2_1.glCompressedTexImage3D(target, level, internalformat, width, height, depth, border, imageSize, data);
		}
		...
		{
			i_OpenGL2_1.glCompressedTexSubImage1D(target, level, xoffset, width, format, imageSize, data);
		}
		...
		{
			i_OpenGL2_1.glCompressedTexSubImage2D(target, level, xoffset, yoffset, width, height, format, imageSize, data);
		}
		...
		{
			i_OpenGL2_1.glCompressedTexSubImage3D(target, level, xoffset, yoffset, zoffset, width, height, depth, format, imageSize, data);
		}
		public static void glCopyPixels(Int32 x, Int32 y, Int32 width, Int32 height, PixelCopyType type)
		{
			i_OpenGL2_1.glCopyPixels(x, y, width, height, type);
		}
		...
		{
			i_OpenGL2_1.glCopyTexImage1D(target, level, internalformat, x, y, width, border);
		}
		...
		{
			i_OpenGL2_1.glCopyTexImage2D(target, level, internalformat, x, y, width, height, border);
		}
		public static void glCopyTexSubImage1D(TextureTarget target, Int32 level, Int32 xoffset, Int32 x, Int32 y, Int32 width)
		{
			i_OpenGL2_1.glCopyTexSubImage1D(target, level, xoffset, x, y, width);
		}
		...
		{
			i_OpenGL2_1.glCopyTexSubImage2D(target, level, xoffset, yoffset, x, y, width, height);
		}
		...
		{
			i_OpenGL2_1.glDrawRangeElements(mode, start, end, count, type, indices);
		}
		public static void glEdgeFlag(Boolean flag)
		{
			i_OpenGL2_1.glEdgeFlag(flag);
		}
		public static void glEdgeFlagPointer(Int32 stride, IntPtr pointer)
		{
			i_OpenGL2_1.glEdgeFlagPointer(stride, pointer);
		}
		public static void glEdgeFlagv(ref Boolean flag)
		{
			i_OpenGL2_1.glEdgeFlagv(ref flag);
		}
		public static void glEnable(EnableCap cap)
		{
			i_OpenGL2_1.glEnable(cap);
		}
		public static void glEnableClientState(EnableCap array)
		{
			i_OpenGL2_1.glEnableClientState(array);
		}
		public static void glEnableVertexAttribArray(UInt32 index)
		{
			i_OpenGL2_1.glEnableVertexAttribArray(index);
		}
		...
		{
			i_OpenGL2_1.glGetActiveAttrib(program, index, bufSize, ref length, ref size, ref type, ref name);
		}
		...
		{
			i_OpenGL2_1.glMap2d(target, u1, u2, ustride, uorder, v1, v2, vstride, vorder, ref points);
		}
		...
		{
			i_OpenGL2_1.glTexImage1D(target, level, internalformat, width, border, format, type, pixels);
		}
		...
		{
			i_OpenGL2_1.glTexImage2D(target, level, internalformat, width, height, border, format, type, pixels);
		}
		...
		{
			i_OpenGL2_1.glTexSubImage1D(target, level, xoffset, width, format, type, pixels);
		}
		...
		{
			i_OpenGL2_1.glTexSubImage2D(target, level, xoffset, yoffset, width, height, format, type, pixels);
		}
