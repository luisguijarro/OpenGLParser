...
{
	internal static class d_OpenGL4_6
	{
		...
		internal delegate void glBlitNamedFramebuffer(UInt32 readFramebuffer, UInt32 drawFramebuffer, Int32 srcX0, Int32 srcY0, Int32 srcX1, Int32 srcY1, Int32 dstX0, Int32 dstY0, Int32 dstX1, Int32 dstY1, UInt32 mask, BlitFramebufferFilter filter);
		...
		internal delegate FramebufferStatus glCheckNamedFramebufferStatus(UInt32 framebuffer, FramebufferTarget target);
		...
		internal delegate void glClearNamedBufferData(UInt32 buffer, InternalFormat internalformat, PixelFormat format, PixelType type, IntPtr data);

		internal delegate void glClearNamedBufferSubData(UInt32 buffer, InternalFormat internalformat, IntPtr offset, IntPtr size, PixelFormat format, PixelType type, IntPtr data);

		internal delegate void glClearNamedFramebufferfi(UInt32 framebuffer, Buffer buffer, Int32 drawbuffer, Single depth, Int32 stencil);

		internal delegate void glClearNamedFramebufferfv(UInt32 framebuffer, Buffer buffer, Int32 drawbuffer, ref Single value);

		internal delegate void glClearNamedFramebufferiv(UInt32 framebuffer, Buffer buffer, Int32 drawbuffer, ref Int32 value);

		internal delegate void glClearNamedFramebufferuiv(UInt32 framebuffer, Buffer buffer, Int32 drawbuffer, ref UInt32 value);
		...
		internal delegate void glCompressedTextureSubImage1D(UInt32 texture, Int32 level, Int32 xoffset, Int32 width, PixelFormat format, Int32 imageSize, IntPtr data);

		internal delegate void glCompressedTextureSubImage2D(UInt32 texture, Int32 level, Int32 xoffset, Int32 yoffset, Int32 width, Int32 height, PixelFormat format, Int32 imageSize, IntPtr data);

		internal delegate void glCompressedTextureSubImage3D(UInt32 texture, Int32 level, Int32 xoffset, Int32 yoffset, Int32 zoffset, Int32 width, Int32 height, Int32 depth, PixelFormat format, Int32 imageSize, IntPtr data);
		...
		internal delegate void glCopyNamedBufferSubData(UInt32 readBuffer, UInt32 writeBuffer, IntPtr readOffset, IntPtr writeOffset, IntPtr size);
		...
		internal delegate void glCreateBuffers(Int32 n, ref UInt32 [] buffers);

		internal delegate void glCreateFramebuffers(Int32 n, ref UInt32 [] framebuffers);

		internal delegate UInt32 glCreateProgram();

		internal delegate void glCreateProgramPipelines(Int32 n, ref UInt32 [] pipelines);

		internal delegate void glCreateQueries(QueryTarget target, Int32 n, ref UInt32 [] ids);

		internal delegate void glCreateRenderbuffers(Int32 n, ref UInt32 [] renderbuffers);

		internal delegate void glCreateSamplers(Int32 n, ref UInt32 [] samplers);
		...
		internal delegate void glCreateTextures(TextureTarget target, Int32 n, ref UInt32 [] textures);

		internal delegate void glCreateTransformFeedbacks(Int32 n, ref UInt32 [] ids);

		internal delegate void glCreateVertexArrays(Int32 n, ref UInt32 [] arrays);
		...
		internal delegate void glFlushMappedNamedBufferRange(UInt32 buffer, IntPtr offset, IntPtr length);
		...
		internal delegate void glGetCompressedTextureImage(UInt32 texture, Int32 level, Int32 bufSize, IntPtr pixels);

		internal delegate void glGetCompressedTextureSubImage(UInt32 texture, Int32 level, Int32 xoffset, Int32 yoffset, Int32 zoffset, Int32 width, Int32 height, Int32 depth, Int32 bufSize, IntPtr pixels);
		...
		internal delegate GraphicsResetStatus glGetGraphicsResetStatus();
		...
		internal delegate void glGetNamedBufferParameteri64v(UInt32 buffer, VertexBufferObjectParameter pname, ref Int64 @params);

		internal delegate void glGetNamedBufferParameteriv(UInt32 buffer, VertexBufferObjectParameter pname, ref Int32 @params);

		internal delegate void glGetNamedBufferPointerv(UInt32 buffer, VertexBufferObjectParameter pname, IntPtr @params);

		internal delegate void glGetNamedBufferSubData(UInt32 buffer, IntPtr offset, IntPtr size, IntPtr data);

		internal delegate void glGetNamedFramebufferAttachmentParameteriv(UInt32 framebuffer, FramebufferAttachment attachment, FramebufferAttachmentParameterName pname, ref Int32 @params);

		internal delegate void glGetNamedFramebufferParameteriv(UInt32 framebuffer, GetFramebufferParameter pname, ref Int32 param);

		internal delegate void glGetNamedRenderbufferParameteriv(UInt32 renderbuffer, RenderbufferParameterName pname, ref Int32 @params);

		internal delegate void glGetnColorTable(ColorTableTarget target, PixelFormat format, PixelType type, Int32 bufSize, IntPtr table);

		internal delegate void glGetnCompressedTexImage(TextureTarget target, Int32 lod, Int32 bufSize, IntPtr pixels);

		internal delegate void glGetnConvolutionFilter(ConvolutionTarget target, PixelFormat format, PixelType type, Int32 bufSize, IntPtr image);

		internal delegate void glGetnHistogram(HistogramTargetEXT target, Boolean reset, PixelFormat format, PixelType type, Int32 bufSize, IntPtr values);

		internal delegate void glGetnMapdv(MapTarget target, MapQuery query, Int32 bufSize, ref Double v);

		internal delegate void glGetnMapfv(MapTarget target, MapQuery query, Int32 bufSize, ref Single v);

		internal delegate void glGetnMapiv(MapTarget target, MapQuery query, Int32 bufSize, ref Int32 v);

		internal delegate void glGetnMinmax(MinmaxTargetEXT target, Boolean reset, PixelFormat format, PixelType type, Int32 bufSize, IntPtr values);

		internal delegate void glGetnPixelMapfv(PixelMap map, Int32 bufSize, ref Single values);

		internal delegate void glGetnPixelMapuiv(PixelMap map, Int32 bufSize, ref UInt32 values);

		internal delegate void glGetnPixelMapusv(PixelMap map, Int32 bufSize, ref UInt16 values);

		internal delegate void glGetnPolygonStipple(Int32 bufSize, ref Byte pattern);

		internal delegate void glGetnSeparableFilter(SeparableTargetEXT target, PixelFormat format, PixelType type, Int32 rowBufSize, IntPtr row, Int32 columnBufSize, IntPtr column, IntPtr span);

		internal delegate void glGetnTexImage(TextureTarget target, Int32 level, PixelFormat format, PixelType type, Int32 bufSize, IntPtr pixels);

		internal delegate void glGetnUniformdv(UInt32 program, Int32 location, Int32 bufSize, ref Double [] @params);

		internal delegate void glGetnUniformfv(UInt32 program, Int32 location, Int32 bufSize, ref Single [] @params);

		internal delegate void glGetnUniformiv(UInt32 program, Int32 location, Int32 bufSize, ref Int32 [] @params);

		internal delegate void glGetnUniformuiv(UInt32 program, Int32 location, Int32 bufSize, ref UInt32 [] @params);
		...
		internal delegate void glGetQueryBufferObjecti64v(UInt32 id, UInt32 buffer, QueryObjectParameterName pname, IntPtr offset);

		internal delegate void glGetQueryBufferObjectiv(UInt32 id, UInt32 buffer, QueryObjectParameterName pname, IntPtr offset);

		internal delegate void glGetQueryBufferObjectui64v(UInt32 id, UInt32 buffer, QueryObjectParameterName pname, IntPtr offset);

		internal delegate void glGetQueryBufferObjectuiv(UInt32 id, UInt32 buffer, QueryObjectParameterName pname, IntPtr offset);
		...
		internal delegate void glGetTextureImage(UInt32 texture, Int32 level, PixelFormat format, PixelType type, Int32 bufSize, IntPtr pixels);

		internal delegate void glGetTextureLevelParameterfv(UInt32 texture, Int32 level, GetTextureParameter pname, ref Single @params);

		internal delegate void glGetTextureLevelParameteriv(UInt32 texture, Int32 level, GetTextureParameter pname, ref Int32 @params);

		internal delegate void glGetTextureParameterfv(UInt32 texture, GetTextureParameter pname, ref Single @params);

		internal delegate void glGetTextureParameterIiv(UInt32 texture, GetTextureParameter pname, ref Int32 @params);

		internal delegate void glGetTextureParameterIuiv(UInt32 texture, GetTextureParameter pname, ref UInt32 @params);

		internal delegate void glGetTextureParameteriv(UInt32 texture, GetTextureParameter pname, ref Int32 @params);

		internal delegate void glGetTextureSubImage(UInt32 texture, Int32 level, Int32 xoffset, Int32 yoffset, Int32 zoffset, Int32 width, Int32 height, Int32 depth, PixelFormat format, PixelType type, Int32 bufSize, IntPtr pixels);

		internal delegate void glGetTransformFeedbacki_v(UInt32 xfb, TransformFeedbackPName pname, UInt32 index, ref Int32 param);

		internal delegate void glGetTransformFeedbacki64_v(UInt32 xfb, TransformFeedbackPName pname, UInt32 index, ref Int64 param);

		internal delegate void glGetTransformFeedbackiv(UInt32 xfb, TransformFeedbackPName pname, ref Int32 param);
		...
		internal delegate void glGetVertexArrayIndexed64iv(UInt32 vaobj, UInt32 index, VertexArrayPName pname, ref Int64 param);

		internal delegate void glGetVertexArrayIndexediv(UInt32 vaobj, UInt32 index, VertexArrayPName pname, ref Int32 param);

		internal delegate void glGetVertexArrayiv(UInt32 vaobj, VertexArrayPName pname, ref Int32 param);
		...
		internal delegate void glInvalidateNamedFramebufferData(UInt32 framebuffer, Int32 numAttachments, ref FramebufferAttachment attachments);

		internal delegate void glInvalidateNamedFramebufferSubData(UInt32 framebuffer, Int32 numAttachments, ref FramebufferAttachment attachments, Int32 x, Int32 y, Int32 width, Int32 height);
		...
		internal delegate IntPtr glMapNamedBuffer(UInt32 buffer, BufferAccessARB access);

		internal delegate IntPtr glMapNamedBufferRange(UInt32 buffer, IntPtr offset, IntPtr length, UInt32 access);
		...
		internal delegate void glMultiDrawArraysIndirectCount(PrimitiveType mode, IntPtr indirect, IntPtr drawcount, Int32 maxdrawcount, Int32 stride);
		...
		internal delegate void glMultiDrawElementsIndirectCount(PrimitiveType mode, GLenum type, IntPtr indirect, IntPtr drawcount, Int32 maxdrawcount, Int32 stride);
		...
		internal delegate void glNamedBufferData(UInt32 buffer, IntPtr size, IntPtr data, VertexBufferObjectUsage usage);

		internal delegate void glNamedBufferStorage(UInt32 buffer, IntPtr size, IntPtr data, UInt32 flags);

		internal delegate void glNamedBufferSubData(UInt32 buffer, IntPtr offset, IntPtr size, IntPtr data);

		internal delegate void glNamedFramebufferDrawBuffer(UInt32 framebuffer, ColorBuffer buf);

		internal delegate void glNamedFramebufferDrawBuffers(UInt32 framebuffer, Int32 n, ref ColorBuffer bufs);

		internal delegate void glNamedFramebufferParameteri(UInt32 framebuffer, FramebufferParameterName pname, Int32 param);

		internal delegate void glNamedFramebufferReadBuffer(UInt32 framebuffer, ColorBuffer src);

		internal delegate void glNamedFramebufferRenderbuffer(UInt32 framebuffer, FramebufferAttachment attachment, RenderbufferTarget renderbuffertarget, UInt32 renderbuffer);

		internal delegate void glNamedFramebufferTexture(UInt32 framebuffer, FramebufferAttachment attachment, UInt32 texture, Int32 level);

		internal delegate void glNamedFramebufferTextureLayer(UInt32 framebuffer, FramebufferAttachment attachment, UInt32 texture, Int32 level, Int32 layer);

		internal delegate void glNamedRenderbufferStorage(UInt32 renderbuffer, InternalFormat internalformat, Int32 width, Int32 height);

		internal delegate void glNamedRenderbufferStorageMultisample(UInt32 renderbuffer, Int32 samples, InternalFormat internalformat, Int32 width, Int32 height);
		...
		internal delegate void glPolygonOffsetClamp(Single factor, Single units, Single clamp);
		...
		internal delegate void glReadnPixels(Int32 x, Int32 y, Int32 width, Int32 height, PixelFormat format, PixelType type, Int32 bufSize, IntPtr data);
		...
		internal delegate void glSpecializeShader(UInt32 shader, ref Char pEntryPoint, UInt32 numSpecializationConstants, ref UInt32 pConstantIndex, ref UInt32 pConstantValue);
		...
		internal delegate void glTextureBuffer(UInt32 texture, InternalFormat internalformat, UInt32 buffer);

		internal delegate void glTextureBufferRange(UInt32 texture, InternalFormat internalformat, UInt32 buffer, IntPtr offset, IntPtr size);

		internal delegate void glTextureParameterf(UInt32 texture, TextureParameterName pname, Single param);

		internal delegate void glTextureParameterfv(UInt32 texture, TextureParameterName pname, ref Single param);

		internal delegate void glTextureParameteri(UInt32 texture, TextureParameterName pname, Int32 param);

		internal delegate void glTextureParameterIiv(UInt32 texture, TextureParameterName pname, ref Int32 @params);

		internal delegate void glTextureParameterIuiv(UInt32 texture, TextureParameterName pname, ref UInt32 @params);

		internal delegate void glTextureParameteriv(UInt32 texture, TextureParameterName pname, ref Int32 param);

		internal delegate void glTextureStorage1D(UInt32 texture, Int32 levels, InternalFormat internalformat, Int32 width);

		internal delegate void glTextureStorage2D(UInt32 texture, Int32 levels, InternalFormat internalformat, Int32 width, Int32 height);

		internal delegate void glTextureStorage2DMultisample(UInt32 texture, Int32 samples, InternalFormat internalformat, Int32 width, Int32 height, Boolean fixedsamplelocations);

		internal delegate void glTextureStorage3D(UInt32 texture, Int32 levels, InternalFormat internalformat, Int32 width, Int32 height, Int32 depth);

		internal delegate void glTextureStorage3DMultisample(UInt32 texture, Int32 samples, InternalFormat internalformat, Int32 width, Int32 height, Int32 depth, Boolean fixedsamplelocations);

		internal delegate void glTextureSubImage1D(UInt32 texture, Int32 level, Int32 xoffset, Int32 width, PixelFormat format, PixelType type, IntPtr pixels);

		internal delegate void glTextureSubImage2D(UInt32 texture, Int32 level, Int32 xoffset, Int32 yoffset, Int32 width, Int32 height, PixelFormat format, PixelType type, IntPtr pixels);

		internal delegate void glTextureSubImage3D(UInt32 texture, Int32 level, Int32 xoffset, Int32 yoffset, Int32 zoffset, Int32 width, Int32 height, Int32 depth, PixelFormat format, PixelType type, IntPtr pixels);
		...
		internal delegate void glTransformFeedbackBufferRange(UInt32 xfb, UInt32 index, UInt32 buffer, IntPtr offset, IntPtr size);
		...
		internal delegate Boolean glUnmapNamedBuffer(UInt32 buffer);
		...
		internal delegate void glVertexArrayAttribFormat(UInt32 vaobj, UInt32 attribindex, Int32 size, VertexAttribType type, Boolean normalized, UInt32 relativeoffset);

		internal delegate void glVertexArrayAttribIFormat(UInt32 vaobj, UInt32 attribindex, Int32 size, VertexAttribType type, UInt32 relativeoffset);

		internal delegate void glVertexArrayAttribLFormat(UInt32 vaobj, UInt32 attribindex, Int32 size, VertexAttribType type, UInt32 relativeoffset);
		...
		internal delegate void glVertexArrayVertexBuffer(UInt32 vaobj, UInt32 bindingindex, UInt32 buffer, IntPtr offset, Int32 stride);

		internal delegate void glVertexArrayVertexBuffers(UInt32 vaobj, UInt32 first, Int32 count, ref UInt32 buffers, IntPtr offsets, ref Int32 strides);
